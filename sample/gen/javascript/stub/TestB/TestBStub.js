...
define(["core/parcel", "core/list", "core/hashTable", "IPC/javascript/Stub", "IPC/javascript/IpcException", "IPC/javascript/CommandCode", "IPC/gen/javascript/stub/TestB/TestBObjectHolder"], function ()
{
    $.declareClass("TestB.BStub", IPC.IStub, {
        ctor: function ()
        {
        ...
        transact: function(bundle)
        {
            ...
            if (code == IPC.CommandCode.commandCreate) {
                ...
                var obj = new TestB.BObjectHolder();
                if (obj == null)
                    return null;
