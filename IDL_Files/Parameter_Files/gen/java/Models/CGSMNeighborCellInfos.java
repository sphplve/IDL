...
public class CGSMNeighborCellInfos extends CRadioMeasParam
{
    public List<CGSMNCInfo> mNeighborCellInfos;
    ...
    public int WriteToParcel(CParcel parcel)
    {
        ...
        if (AResult.AFAILED(parcel.WriteString("Models.CGSMNeighborCellInfos")))
            return AResult.AE_FAIL;
    ...
    public Boolean Copy(CGSMNeighborCellInfos info)
    {
        if (info == null)
            return false;
        ...
        if (info.mNeighborCellInfos != null) {
            if (mNeighborCellInfos != null)
                ...
                mNeighborCellInfos = new LinkedList<CGSMNCInfo>();
    ...
    public String ToString()
    {
        ...
        for(int i = 0; i < mNeighborCellInfos.size(); ++i) {
            CGSMNCInfo obj = mNeighborCellInfos.get(i);
            String comma = null;
    ...
    {
        return "Models.CGSMNeighborCellInfos";
    }
}
