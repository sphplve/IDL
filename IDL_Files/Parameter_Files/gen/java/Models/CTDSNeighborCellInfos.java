...
public class CTDSNeighborCellInfos extends CRadioMeasParam
{
    public List<CTDSNCInfo> mNeighborCellInfos;
    ...
    public int WriteToParcel(CParcel parcel)
    {
        ...
        if (AResult.AFAILED(parcel.WriteString("Models.CTDSNeighborCellInfos")))
            return AResult.AE_FAIL;
    ...
    public Boolean Copy(CTDSNeighborCellInfos info)
    {
        if (info == null)
            return false;
        ...
        if (info.mNeighborCellInfos != null) {
            if (mNeighborCellInfos != null)
                ...
                mNeighborCellInfos = new LinkedList<CTDSNCInfo>();
    ...
    public String ToString()
    {
        ...
        for(int i = 0; i < mNeighborCellInfos.size(); ++i) {
            CTDSNCInfo obj = mNeighborCellInfos.get(i);
            String comma = null;
    ...
    {
        return "Models.CTDSNeighborCellInfos";
    }
}
