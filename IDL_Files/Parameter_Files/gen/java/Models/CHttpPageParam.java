...
public class CHttpPageParam extends CRadioMeasParam
{
    ...
    public int WriteToParcel(CParcel parcel)
    {
        ...
        if (AResult.AFAILED(parcel.WriteString("Models.CHttpPageParam")))
            return AResult.AE_FAIL;
    ...
    public Boolean Copy(CHttpPageParam info)
    {
        if (info == null)
            return false;
