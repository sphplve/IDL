...
public class CHttpPageTestRecord extends CTestRecord
{
    public int mIndex;
    ...
    public int WriteToParcel(CParcel parcel)
    {
        ...
        if (AResult.AFAILED(parcel.WriteString("TestWorkModels.CHttpPageTestRecord")))
            return AResult.AE_FAIL;
    ...
    public Boolean Copy(CHttpPageTestRecord info)
    {
        if (info == null)
            return false;
    ...
    {
        return "TestWorkModels.CHttpPageTestRecord";
    }
}
