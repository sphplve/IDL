...
public class CFtpTestRecord extends CTestRecord
{
    ...
    public int WriteToParcel(CParcel parcel)
    {
        ...
        if (AResult.AFAILED(parcel.WriteString("TestWorkModels.CFtpTestRecord")))
            return AResult.AE_FAIL;
        ...
        if (AResult.AFAILED(parcel.WriteInt32(mUsers)))
            return AResult.AE_FAIL;
    ...
    public Boolean Copy(CFtpTestRecord info)
    {
        if (info == null)
            return false;
    ...
    {
        return "TestWorkModels.CFtpTestRecord";
    }
}
